namespace ControlRoomApplication.Constants
{
    public sealed class MiscellaneousHardwareConstants
    {
        ...
        public const double WEATHER_STATION_WARNING_WIND_SPEED_MPH = 1.0;
        public const double WEATHER_STATION_MAXIMUM_ALLOWABLE_WIND_SPEED_MPH = 5.0;
        public const double SIMULATION_WEATHER_STATION_AVERAGE_WIND_SPEED_MPH = 2.0;
